...
public class AttractorIP extends AbstractIP {
	private String edgeWithIndexFileString;
	
	public AttractorIP(String edgeInputFileString,
			String nameIndexMapFileString, String edgeWithIndexFileString)
			throws Exception {
	...
	public static void main(String[] args) throws Exception{
		// TODO Auto-generated method stub
		new AttractorIP(args[0], args[1], args[2]).write2EdgeWithIndexFile();
	}
