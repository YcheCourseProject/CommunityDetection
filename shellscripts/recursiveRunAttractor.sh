        ...
        if [ -d $1"/"$file ];then
            ...
            if [[ $file =~ .*input.csv$ ]];then
                ...
                do
                    ...
                    output_attractor_old_suffix="_attractor_old_"$lamda_str".clu"
                    output_connected_componets_attractor_old_suffix="_attractor_old_"$lamda_str".cc"
                    clu_out_file=${init_infile//edges_input.csv/${output_attractor_old_suffix}};
                    components_outfile=${init_infile//edges_input.csv/${output_connected_componets_attractor_old_suffix}} 
